...
public class InversionsCountByMergeSortingTest {
    ...
    public void simpleTest() {
        ...
        Assertions.assertEquals(new Long(2), result);
    }
    ...
    public void onlyOneElementGreaterThenNextTest() {
        ...
        Assertions.assertEquals(new Long(1), result);
    }
