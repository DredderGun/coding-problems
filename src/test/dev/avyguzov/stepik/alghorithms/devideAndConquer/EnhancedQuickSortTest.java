...
public class EnhancedQuickSortTest {
    ...
    public void mustCorrectlySortArray() {
        ...
        Assertions.assertArrayEquals(new int[]{0, 1, 5, 7, 8, 9}, list);
    }
    ...
    public void mustCorrectlySortReversedArray() {
        ...
        Assertions.assertArrayEquals(new int[] {4, 5, 6, 7, 8, 9}, list);
    }
    ...
    public void mustCorrectlySortAlreadySortedArray() {
        ...
        Assertions.assertArrayEquals(new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9}, list);
    }
    ...
    public void mustCorrectlySortFewUniqueArrayElements() {
        ...
        Assertions.assertArrayEquals(new int[]{1, 1, 1, 1, 2, 2, 2, 3, 3, 5, 5}, list);
    }
}
