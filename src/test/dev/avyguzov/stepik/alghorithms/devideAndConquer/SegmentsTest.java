...
public class SegmentsTest {
    ...
    public void testSegments() {
        ...
        Assertions.assertEquals(Arrays.asList(1, 0, 0),
    ...
    public void ordinaryTest() {
        ...
        Assertions.assertEquals(Arrays.asList(2, 3, 1),
    ...
    public void testFromStepik() {
        ...
        Assertions.assertEquals(Arrays.asList(2, 3, 6, 3, 2, 1),
    ...
    public void anotherTestFromStepik() {
        ...
        Assertions.assertEquals(Arrays.asList(0, 4, 5, 7, 6),
    ...
    public void test() {
        ...
        Assertions.assertEquals(Arrays.asList(2, 4),
